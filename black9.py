...
def CHangeRoomName(room_id, key, iv):
    fields = {1: 13,2: {1: int(room_id),2: f"{GeneratRandomHexColor()}GC SUMON",4: 1,5: 15,6: 8,7: 30,8: 1,9: 1,10: 2,11: 36981056,12: 2368584,13: 1,18: {0: 1},30: 1}}
