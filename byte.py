...
def xSEndMsg(Msg , Tp , Tp2 , id , K , V):
    feilds = {1: id, 2: Tp2, 3: Tp, 4: Msg , 5: 1735129800, 7: 2, 9: {1: "ARAFAT", 2: xBunnEr(), 3: 901048018, 4: 330, 5: 909034009, 8: "ARAFAT", 10: 1, 11: 1, 14: {1: 1158053040, 2: 8, 3: "\u0010\u0015\b\n\u000b\u0015\f\u000f\u0011\u0004\u0007\u0002\u0003\r\u000e\u0012\u0001\u0005\u0006"}}, 10: "en", 13: {2: 1, 3: 1}, 14: {}}
...
def CHangeRoomName(room_id, key, iv):
    fields = {1: 13,2: {1: int(room_id),2: f"{GeneratRandomHexColor()}GC ARAFAT",4: 1,5: 15,6: 8,7: 30,8: 1,9: 1,10: 2,11: 36981056,12: 2368584,13: 1,18: {0: 1},30: 1}}
